//
//  ClubChatViewcotroller.swift
//  newChat
//
//  Created by 吉田成秀 on 2022/03/23.
//
...
class ClubChatViewcotroller: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        defaultstore.collection("clubchat").addSnapshotListener { (snapShot, error) in
...
extension ClubChatViewcotroller:UITextFieldDelegate {
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        //Firestoreに送信する
        defaultstore.collection("clubchat").addDocument(data: messageData)
